...
description: "Lion Shield's three-person team followed up Kingdoms and Castles with a Roman city builder where water physics, divine wrath, and complex supply chains collide. Nine days into Early Access, it's sitting at 97% positive on Steam."
cover:
  image: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2426530/header.jpg"
  alt: "Nova Roma"
---

Nine days into Early Access and [**Nova Roma**](https://store.steampowered.com/app/2426530/Nova_Roma/) is sitting at 97% positive across 834 reviews on Steam. For a city builder from a three-person studio, those are remarkable numbers — the kind that suggest something genuinely clicked, not just with genre diehards but with a broader audience willing to take a bet on an unfinished game.

![Nova Roma](https://cdn.akamai.steamstatic.com/steam/apps/2426530/header.jpg)

## Who's behind it

**Lion Shield** is the studio, and if the name doesn't ring a bell, their previous game probably does: [**Kingdoms and Castles**](https://store.steampowered.com/app/569480/Kingdoms_and_Castles/), the medieval city builder that launched in 2017 and quietly became one of Steam's most beloved indie strategy titles. It's the same core team — Pete Angstadt as Creative Director, with a tiny crew that somehow punches well above its weight.
...
**Nova Roma** is available now in Early Access on [Steam](https://store.steampowered.com/app/2426530/Nova_Roma/) and PC Game Pass.
